document.addEventListener("DOMContentLoaded", () => {
    ...
    d3.json("http://localhost:8080/lib/fudes.json", function (data) {
        debugger
        return nutritionalInfo = data.food.servings.serving;
    })
    ...
    // var stack = d3.stack()
    //     .keys(['pizza', 'pho', 'ramen', 'avacado', 'fries', 'beer', 'icecream', 'cookie']);
