document.addEventListener('DOMContentLoaded', () => {
    ...
    let totalCals = calData.map((ele => {
        let hash = { category: '', value: '' }
            ...
            countMacros.Calories += parseFloat(ele.value)
    ...
    const calories = svg.selectAll('calories')
        ...
        .append('g')
        .attr('class', 'legend')
        .attr('transform', 'translate(-42.5, 33)')
    ...
    svg.append('text')
        .data(totalCals)
        .attr('transform', 'translate(0, -0) rotate(122)')
        .append('textPath')
